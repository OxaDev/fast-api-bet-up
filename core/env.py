...
if REDIS_MAIN_PASSWORD:
    REDIS_MAIN_BROKER_URL = f"redis://:{REDIS_MAIN_PASSWORD}@{REDIS_MAIN_ENDPOINT}:{REDIS_MAIN_PORT}"
else:
    REDIS_MAIN_BROKER_URL = f"redis://{REDIS_MAIN_ENDPOINT}:{REDIS_MAIN_PORT}"

# Celery Configuration
CELERY_MAIN_BROKER_URL = REDIS_MAIN_BROKER_URL + "/0"
CELERY_MAIN_RESULT_BACKEND = CELERY_MAIN_BROKER_URL

# RedBeat
REDIS_REDBEAT_URL = REDIS_MAIN_BROKER_URL + "/1"
